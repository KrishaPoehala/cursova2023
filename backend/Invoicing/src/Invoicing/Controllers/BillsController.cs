...
using Invoicing.Application.Bills.Queries.RetreiveBill;
...
namespace Invoicing.Controllers
{
    public class BillsController : ApiControllerBase
    {
        ...
        [HttpGet("{billId}/retreive")]
        public async Task<IActionResult> RetreiveBill(long billId)
        {
            return Ok(await Mediator.Send(new RetreiveBillQuery() { BillId = billId }));
        }
